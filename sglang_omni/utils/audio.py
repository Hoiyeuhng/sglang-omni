...
def resample_kernel(
    ...
    return torchaudio.functional.functional._get_sinc_resample_kernel(  # ast-grep-ignore: leading-underscore  # upstream spelling, or the public name is already taken
        orig_freq,
        new_freq,
        gcd,
        device=device,
...
def cached_resample(
    ...
    try:
        ...
        return torchaudio.functional.functional._apply_sinc_resample_kernel(  # ast-grep-ignore: leading-underscore  # upstream spelling, or the public name is already taken
