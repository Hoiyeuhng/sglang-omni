...
def build_sglang_minimax_request(
    ...
    uncond_req._input_embeds_are_projected = True  # ast-grep-ignore: leading-underscore  # upstream spelling, or the public name is already taken
    uncond_req._codec_suppress_tokens = None  # ast-grep-ignore: leading-underscore  # upstream spelling, or the public name is already taken
