...
def compile_dit_backbone(
    ...
    *,
    ...
    torch._inductor.config.fx_graph_cache = True  # ast-grep-ignore: leading-underscore  # upstream spelling, or the public name is already taken
    torch._dynamo.config.cache_size_limit = 1024  # ast-grep-ignore: leading-underscore  # upstream spelling, or the public name is already taken
    torch._dynamo.config.accumulated_cache_size_limit = 1024  # ast-grep-ignore: leading-underscore  # upstream spelling, or the public name is already taken
