...
def build_sglang_thinker_request(
    ...
    *,
    ...
    if model_inputs and thinker_config is not None:
        ...
        req._omni_mm_positions = mm_positions  # ast-grep-ignore: leading-underscore  # upstream spelling, or the public name is already taken
...
def build_sglang_talker_request(
    ...
    *,
    ...
    req._omni_consumed = None  # ast-grep-ignore: leading-underscore  # upstream spelling, or the public name is already taken
    req._codec_suppress_tokens = (  # ast-grep-ignore: leading-underscore  # upstream spelling, or the public name is already taken
