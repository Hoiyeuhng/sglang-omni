...
def init_sglang_tp() -> None:
    ...
    dp._ATTN_TP_SIZE = 1  # ast-grep-ignore: leading-underscore  # upstream spelling, or the public name is already taken
    dp._ATTN_TP_RANK = 0  # ast-grep-ignore: leading-underscore  # upstream spelling, or the public name is already taken
